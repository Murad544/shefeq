...
const LandingPage = () => {
  ...
  return (
    <>
      <Navbar />
      <Box sx={{background: `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.primary.dark} 50%, ${theme.palette.primary.main} 100%)`,
}}>
      <Box
        sx={{
          minHeight: "100vh",
          ...
          <Fade in timeout={800}>
            ...
            >
              ...
              <Container maxWidth="md" sx={{ px: 0 }}>
                <Grid container spacing={3} textAlign="left" justifyContent="center">
