...
const theme = createTheme({
  ...
  components: {
    ...
    MuiTableCell: {
      styleOverrides: {
        root: {
          ...
          "@media (max-width:960px)": { padding: "8px", fontSize: "0.8rem" },
          "@media (max-width:600px)": { padding: "6px", fontSize: "0.75rem" },
        },
        head: {
          ...labelCaps,
          fontSize: "0.78rem",
    ...
    MuiTabs: {
      styleOverrides: {
        root: { minHeight: 44 },
        indicator: { height: 3, borderRadius: 0, backgroundColor: C.brass },
      },
    },
    MuiTab: {
      styleOverrides: {
